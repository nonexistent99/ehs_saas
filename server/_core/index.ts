  ...
  app.get("/api/export/pt/:id", async (req: express.Request, res: express.Response) => {
    try {
      ...
      const pdfBuffer = await generatePtPdf({
        ...
        serviceDescription: parsedContent.serviceDescription || record.pt.description || record.pt.title,
        ...
        issuerName: parsedContent.issuerName || "",
        supervisorName: parsedContent.supervisorName || "",
