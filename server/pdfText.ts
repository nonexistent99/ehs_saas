...
const portugueseGlossary: Array<[RegExp, string]> = [
  ...
  [/\binspe[?�]{1,2}o\b/gi, "inspeção"],
  [/\binspe[?�]{1,2}es\b/gi, "inspeções"],
  [/\borganiza[?�]{1,2}o\b/gi, "organização"],
  [/\bcircula[?�]{1,2}o\b/gi, "circulação"],
  [/\bsinaliza[?�]{1,2}o\b/gi, "sinalização"],
  [/\bsitua[?�]{1,2}o\b/gi, "situação"],
  [/\bcorre[?�]{1,2}o\b/gi, "correção"],
  [/\baten[?�]{1,2}o\b/gi, "atenção"],
  [/\borienta[?�]{1,2}o\b/gi, "orientação"],
  [/\binterven[?�]{1,2}o\b/gi, "intervenção"],
  [/\bpr[?�]xima\b/gi, "próxima"],
  [/\bpr[?�]ximo\b/gi, "próximo"],
  [/\brefor[?�]ar\b/gi, "reforçar"],
  [/\bevid[?�]ncia\b/gi, "evidência"],
  [/\bevid[?�]ncias\b/gi, "evidências"],
  [/\bdescri[?�]{1,2}o\b/gi, "descrição"],
  [/\bdecis[?�]{1,2}es\b/gi, "decisões"],
  [/\bpadr[?�]o\b/gi, "padrão"],
  [/\bs[?�]o\b/gi, "são"],
  [/\bn[?�]o\b/gi, "não"],
  ...
  [/\bha\b/gi, "há"],
  [/\binicio\b/gi, "início"],
  [/\binicios\b/gi, "inícios"],
  [/\bapos\b/gi, "após"],
  [/\borientacao\b/gi, "orientação"],
  [/\borientacoes\b/gi, "orientações"],
  [/\bintervencao\b/gi, "intervenção"],
  [/\bintervencoes\b/gi, "intervenções"],
